               ...
               <div class="col-lg-8 offset-lg-2">
                  <div class="full">
                     ...
                     <?php 
                        ...
                        $message = '<p>Château Bob l éponge planeteanimation.com</p>
                        <p><b>Email : </b>' . $_POST['email'] . '<br>
                        <b>Message : </b>' . htmlspecialchars($_POST['message']) . '</p>';

                        $retour = mail('prencipelouis@gmail.com', 'Château Bob l éponge', $message, $entete);
                        if($retour)
